...
public class TCPConnectionTest {
    ...
    public void testGetConnectionType() {
        TCPConnection c = mock(TCPConnection.class, CALLS_REAL_METHODS);
        
        assertThat(c.getConnectionType(), is(equalTo(ConnectionType.TCP)));
    }
    ...
    public void testIsListening() {
        ...
        expected.put(ConnectionState.CLOSE, false);
